...
public class CommonUtils {
   ...
   public static String isValidName(Activity var0, String name) {
      ...
      name = name.trim();
      if(name.isEmpty()) {
    	 //-spb for errors AlertBox(var0, "Name", "Name is empty");
    	  AlertBox(var0, "Can't add name ", "Kindly enter name");
      } else if(name.length() > 12) {
    	//-spb for errors AlertBox(var0, "Name", "Name should not be more than 12 chars");
    	  AlertBox(var0, "Maximum limit reached !", "Name should not be more than 12 chars");
      } else if(name.contains("#")) {
    	//-spb for errors AlertBox(var0, "Name", "Name should not contain # letter in the name");
    	  AlertBox(var0, "Special characters not allowed", "Name characters should be A-Z and 0-9");
      } else {
