...
public class DiscoveryActivity extends ZorbaActivity {
				...
				public Object runTask(Object params) {
					...
					if (currentDiscoveryType == DISCOVERYTYPE_WAP) {
						...
						try {
							...
							if (error != null) {
								//-spb 161216 for errors CommonUtils.AlertBox(DiscoveryActivity.this, "Discovery",
								//-spb 161216 for errors 		"Not able to init connection " + droom.getRoomName() + " : " + error);
								CommonUtils.AlertBox(DiscoveryActivity.this, "Discovery",
										"Not able to connect device " + droom.getRoomName() + " : " + error);
						...
						try {
							...
							if (currentWifiSSID != null && isMaster) {
								...
								if (response != null) {
									if (response[0] != 48) {
										//-spb 161216 for errors CommonUtils.AlertBox(DiscoveryActivity.this, "Discovery",
										//-spb 161216 for errors		"Ip address is not set for " + droom.getRoomName());
										CommonUtils.AlertBox(DiscoveryActivity.this, "Discovery",
												"Could not assign IP address to device " + droom.getRoomName());
										
										return null;
									}
									
								} else {
									//-spb 161216 for errors CommonUtils.AlertBox(DiscoveryActivity.this, "Ip set",
									//-spb 161216 for errors		"No response from device for ip set");
	...
	private void populateCurrentSSID() {
		if (currentDiscoveryType == DISCOVERYTYPE_WR) {
			...
			if (currentWifi == null || currentWifi.getSSID() == null || currentWifi.getSSID().isEmpty()) {
				//-spb 161216 for errors CommonUtils.AlertBox(this, "Discovery", "Wifi connection is not enabled");
				CommonUtils.AlertBox(this, "Discovery", "Kindly start Wifi on phone and try again");//-spb 161216 for errors
				return;
			}
	...
	public void onBackPressed() {
		...
		if( !CommonUtils.isActiveNetwork(this)) {
			//-spb 161216 for errors CommonUtils.AlertBox(this, "Network", "Please enable network");
	...
	protected void onCreate(Bundle var1) {
		...
		if (mBluetoothManager == null) {
			...
			if (mBluetoothManager == null) {
				//-spb 161216 for errors CommonUtils.AlertBox(this, "Bt Manager", "Unable to initialize BluetoothManager.");
				CommonUtils.AlertBox(this, "Bt Manager", "Unable to initialize Bluetooth Manager.");
				return;
			}
		}
		...
		saveButton.setOnClickListener(new OnClickListener() {
			public void onClick(View var1) {
				...
				if (currentDiscoveryType == DISCOVERYTYPE_WR && pwd.isEmpty() && isMaster) {
					//-spb 161216 for errors CommonUtils.AlertBox(DiscoveryActivity.this, "Wifi", "Password is empty");
				...
				if (nonEmptyChildren.size() == 0) {
					//-spb 161216 for errors CommonUtils.AlertBox(DiscoveryActivity.this, "Discovery", "Name is empty");
