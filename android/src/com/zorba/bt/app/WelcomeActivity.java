	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gotoButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View paramAnonymousView1) {
				...
				if( emailid == null) {
					//-spb 161216 for errors CommonUtils.AlertBox(WelcomeActivity.this, "Error", "Enter valid email id");
					CommonUtils.AlertBox(WelcomeActivity.this, "Error", "Enter valid email address");
					return;
				}
				RadioButton masterbox = (RadioButton)findViewById(R.id.master);
