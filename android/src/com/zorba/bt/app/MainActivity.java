						...
						.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface paramAnonymous2DialogInterface,
								...
								try {
									...
									//-spb 161216 for errors CommonUtils.AlertBox(MainActivity.this, "Delete Scheduler",
									//-spb 161216 for errors		"Not able to send delete schedule(" + MainActivity.this.selectedScheduleName
									//-spb 161216 for errors				+ "): " + paramAnonymous2DialogInterfacee.getMessage());
									CommonUtils.AlertBox(MainActivity.this, "Delete Scheduler",
											"Not able to delete schedule(" + MainActivity.this.selectedScheduleName
	...
	private void readAndUpateStatusForRoom(boolean update) {
		...
		if (update) {
			try {
				...
				if (allStatus == null) {
					//-spb 161216 for errors CommonUtils.AlertBox(this, "Device count", "No data from device");
					CommonUtils.AlertBox(this, "Device communication", "No communication with the device");
					return;
				}
		...
		runOnUiThread(new Runnable() {
			public void run() {
				...
				try {
					...
					//-spb 161216 for errors CommonUtils.AlertBox(MainActivity.this, "Read Power", "No data from device");
					CommonUtils.AlertBox(MainActivity.this, "Read Power", "No communication with the device");
				}
			}
		});
	}
				...
				public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {
					if( fromUser ) {
						...
						try {
							...
							//-spb 161216 for errors CommonUtils.AlertBox(MainActivity.this, "Error",
							//-spb 161216 for errors		"Sending cmd to Device:" + paramAnonymousSeekBare.getMessage());
							CommonUtils.AlertBox(MainActivity.this, "Error",
									"Sending command to Device:" + paramAnonymousSeekBare.getMessage());
						}
			...
			public Object runTask(Object params) {
				...
				if( btHwLayer.isWifiEnabled()) {
					if( incomingssid != null && !incomingssid.isEmpty() && !incomingssid.equals("null")) {
						...
						if( ipaddress == null) {
							//-spb 161216 for errors CommonUtils.AlertBox(MainActivity.this, "Connection", "Ipaddress is found for ssid:"+incomingssid);
							CommonUtils.AlertBox(MainActivity.this, "Connection", "IP address is found for network:"+incomingssid);
